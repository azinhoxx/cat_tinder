...
|-|-|-|-|
| Главный экран | Описание. <br> Часть 1 | Описание. <br> Часть 2 | Полноэкранный режим изображения |
...
Из-за ограничения CORS в Web версии отсутствуют изображения. Более того, дополнительная проверка интернета отключается — считается, что подключение всегда есть. В остальном приложение работает аналогично Windows, Android.
